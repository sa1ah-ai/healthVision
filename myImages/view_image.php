                ...
                <div class="contrain-fluid">
                    ...
                    <div>
                        <?php if (isset($image_path) && !empty($image_path)): ?>
                            <div class="img-box">
                                <img src="<?php echo $image_path; ?>" alt="image" style="max-width: 100%; height: 100%;">
                            </div>
                        <?php else: ?>
                                ...
                                <div class="d-flex align-items-center w-100">
                                    ...
                                    <div class="col-auto flex-shrink-1 flex-grow-1">
                                        <div style="line-height:1em">
                                            <small class="badge badge-primary border text-light rounded-pill px-3 me-2"><i class="far fa-circle-dot"></i> <?= $row['confidence'] ?></small>
                                            <small class="badge badge-btn border text-dark rounded-pill px-3 me-2"> <?= date("Y-m-d h:i a", strtotime($row['created_at'])) ?></small>
                                        </div>
                                    </div>

                                </div>
                                <hr>
                                <div class="font-weight-bolder"><?= $row['diagnosis'] ?></div>
                            </div>
                        <?php endwhile; ?>
                    </div>
                    ...
                    <div class="list-group comment-list mb-3 rounded-0">
                        ...
                        $comments = $conn->query("SELECT mi.*, res.*, docr.*, u.* FROM `medicalimages` mi
                                                    ...
                                                    where mi.image_id ='{$image_id}'
                                                    And docr.delete_flag = 0
                                ...
                                <div class="d-flex align-items-center w-100">
                                    ...
                                    <div class="col-auto flex-shrink-1 flex-grow-1">
                                        <div style="line-height:1em">
                                            ...
                                            <small class="badge badge-btn border text-dark rounded-pill px-3 me-2"> <?= date("Y-m-d h:i a", strtotime($row['reviewed_at'])) ?></small>
...
<script>
    $(function() {
        ...
        $('#delete_image').click(function() {
            _conf("Are your sure to delete this image?", "delete_image", ['<?= isset($image_id) ? $image_id : '' ?>'])
        })
        $('#comment').summernote({
            height: "15em",
